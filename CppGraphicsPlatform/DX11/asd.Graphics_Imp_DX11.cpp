...
//
//----------------------------------------------------------------------------------
VertexBuffer_Imp* Graphics_Imp_DX11::CreateVertexBuffer_Imp_refactor_old_(int32_t size, int32_t count, bool isDynamic)
{
...
//
//----------------------------------------------------------------------------------
IndexBuffer_Imp* Graphics_Imp_DX11::CreateIndexBuffer_Imp_refactor_old_(int maxCount, bool isDynamic, bool is32bit)
{
...
//
//----------------------------------------------------------------------------------
NativeShader_Imp* Graphics_Imp_DX11::CreateShader_Imp_refactor_old_(
...
//
//----------------------------------------------------------------------------------
Texture2D_Imp* Graphics_Imp_DX11::CreateTexture2D_Imp_Internal_refactor_old_(Graphics* graphics, uint8_t* data, int32_t size)
{
	auto ret = Texture2D_Imp_DX11::Create(this, data, size, false, this->GetOption().ColorSpace == ColorSpaceType::LinearSpace);
	return ret;
}

Texture2D_Imp* Graphics_Imp_DX11::CreateTexture2DAsRawData_Imp_Internal_refactor_old_(Graphics* graphics, uint8_t* data, int32_t size)
{
	auto ret = Texture2D_Imp_DX11::Create(this, data, size, false, false);
	return ret;
}

Texture2D_Imp* Graphics_Imp_DX11::CreateEmptyTexture2D_Imp_Internal_refactor_old_(
...
Texture2D_Imp* Graphics_Imp_DX11::CreateEditableTexture2D_Imp_Internal_refactor_old_(Graphics* graphics, uint8_t* data, int32_t size)
{
...
//
//----------------------------------------------------------------------------------
RenderTexture2D_Imp* Graphics_Imp_DX11::CreateRenderTexture2D_Imp_refactor_old_(int32_t width, int32_t height, TextureFormat format)
{
